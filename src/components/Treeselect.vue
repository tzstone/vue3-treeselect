...
const instance = computed(() => ({
  ...
  checkedStateMap: _forest.checkedStateMap,
  localSearch: {
    active: _localSearch.active,
    countMap: _localSearch.countMap,
  },
  ...
  rootOptionsStates: {
    isLoaded: _rootOptionsStates.isLoaded,
    isLoading: _rootOptionsStates.isLoading,
    loadingError: _rootOptionsStates.loadingError,
  },
  forest: {
    normalizedOptions: _forest.normalizedOptions,
  },
  remoteSearch: _remoteSearch,
